...
| [Модель монетизации](https://nbviewer.jupyter.org/github/kotl68/introductions/blob/master/model/model.ipynb) | Сформировать модель монетизации игрового приложения. | pandas, scipy, matplotlib, numpy, math, seaborn, plotly, pandas_profiling  | В процессе доработки
