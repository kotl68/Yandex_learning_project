...
**Если проект не открывает или вы хотите отобразить график библиотеки plotly то можно воспользоваться этим сайтом https://nbviewer.jupyter.org/ 
Просто скопировав ссылку проекта и нажав** `GO`
